...
function timer() {
  ...
  function getTimeRemaining(endtime) {
    var t = Date.parse(endtime) - Date.parse(new Date()),
        ...
        hours = Math.floor(t / (1000 * 60 * 60)); // hours = Math.floor((t/1000/60/60) % 24)              For 24 hours format
    // days = Math.floor((t/(1000*60*60*24)));              If you need days
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var calc = __webpack_require__(/*! ./parts/calc.js */ "./src/js/parts/calc.js"),
      form_old = __webpack_require__(/*! ./parts/form_old.js */ "./src/js/parts/form_old.js"),
